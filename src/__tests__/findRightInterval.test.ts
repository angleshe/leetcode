...
describe('src/findRightInterval', () => {
  describe('findRightInterval', () => {
    it('[[1,2]]', () => assert.deepStrictEqual(findRightInterval([[1, 2]]), [-1]));
    it('[[3,4],[2,3],[1,2]]', () =>
